...
client.on('message', msg => {  //N' 1 C H O‘☥ •#3225 
    if (msg.content === 'باك') {  //N' 1 C H O‘☥ •#3225 
      msg.reply('** :wink: وِلِـكُمِـ ﻧَوِرُتْ   :sparkling_heart:**');  //N' 1 C H O‘☥ •#3225 
    }
  });

client.on('message', msg => {  //N' 1 C H O‘☥ •#3225 
    if (msg.content === 'هلا') {  //N' 1 C H O‘☥ •#3225 
      msg.reply('**مرحبا**');  //N' 1 C H O‘☥ •#3225 
    }
  });


client.on('message', msg => {  //N' 1 C H O‘☥ •#3225 
    if (msg.content === 'احبك') {  //N' 1 C H O‘☥ •#3225 
      msg.reply('**لاتحتك يا اخوي لو سمحت**');  //N' 1 C H O‘☥ •#3225 
    }
  });
  ...
  client.on('message', msg => {  //N' 1 C H O‘☥ •#3225 
    if (msg.content === 'احبك') {  //N' 1 C H O‘☥ •#3225 
      msg.reply('**حبك برص يا سافل**');  //N' 1 C H O‘☥ •#3225 
    }
  });
   ...
   client.on('message', msg => {  //N' 1 C H O‘☥ •#3225 
    if (msg.content === 'سلام') {  //N' 1 C H O‘☥ •#3225 
      msg.reply('**هلا بيك :heart: **');  //N' 1 C H O‘☥ •#3225 
    }
  });
  ...
  client.on("message", message => {  //N' 1 C H O‘☥ •#3225 
    if(message.content.startsWith(prefix + 'v2min')) {  //N' 1 C H O‘☥ •#3225 
     let args = message.content.split(" ").slice(1);  //N' 1 C H O‘☥ •#3225 
       var nam = args.join(' ');
    
      if(!message.member.hasPermission('ADMINISTRATOR')) return    message.channel.send('`ADMINISTRATOR` للأسف هذه الخاصية تحتاج الى ').then(msg => msg.delete(6000))
      if (!nam) return message.channel.send(`<@${message.author.id}> يجب عليك ادخال اسم`).then(msg => msg.delete(10000))  //N' 1 C H O‘☥ •#3225 
      message.guild.createChannel(nam, 'voice').then(c => setTimeout(() => c.delete(), 120000))   //N' 1 C H O‘☥ •#3225 
...
client.on("message", message => {    //N' 1 C H O‘☥ •#3225 
    if(message.content.startsWith(prefix + "emoji")) {   //N' 1 C H O‘☥ •#3225 
        if(message.author.bot) return;  //N' 1 C H O‘☥ •#3225 
        var emojiid =  message.content.split(" ").slice(1).join(" ")   //N' 1 C H O‘☥ •#3225 
        console.log(emojiid) 
        if(emojiid.length < "18" || emojiid.length > "18" || isNaN(emojiid)) return  message.channel.send(`- Usage  //N' 1 C H O‘☥ •#3225 
${prefix}emoji <EmojiID>`); 
        else    
        message.channel.send("This is the emoji that you requested:-",  //N' 1 C H O‘☥ •#3225 
          { 
            files: [`https://cdn.discordapp.com/emojis/${emojiid}.png`]  //N' 1 C H O‘☥ •#3225 
          }) 
        }  
})   
 ...
 client.on("message", message => {  //N' 1 C H O‘☥ •#3225 
  if (message.channel.type === "dm") {    //N' 1 C H O‘☥ •#3225 

      message.channel.startTyping();    //N' 1 C H O‘☥ •#3225 
      setTimeout(() => {    //N' 1 C H O‘☥ •#3225 
        message.channel.stopTyping();    //N' 1 C H O‘☥ •#3225 
      }, Math.random() * (1 - 3) + 1 * 1000);  //N' 1 C H O‘☥ •#3225 
   
  }  
});  

const clans = {};  //N' 1 C H O‘☥ •#3225 
const system = {};  //N' 1 C H O‘☥ •#3225 
const level = {};  //N' 1 C H O‘☥ •#3225 
 
 
client.on('message',async message => {  //N' 1 C H O‘☥ •#3225 
  if(message.author.bot) return;  //N' 1 C H O‘☥ •#3225 
  if(message.channel.type === 'dm') return;  //N' 1 C H O‘☥ •#3225 
 
  let args = message.content.split(' ');  //N' 1 C H O‘☥ •#3225 
  let random = Math.floor(Math.random() * 5) + 2;  //N' 1 C H O‘☥ •#3225 
  let author = message.author;
 
  let xpLeft;  //N' 1 C H O‘☥ •#3225 
  let nameClan;  //N' 1 C H O‘☥ •#3225 
  let membersClan = [];  //N' 1 C H O‘☥ •#3225 
  let levelClan = 0;  //N' 1 C H O‘☥ •#3225 
  if(!system[author.id]) system[author.id] = {clan: 'None',joinedAt: new Date().toLocaleString() ,clanLevel: 0};  //N' 1 C H O‘☥ •#3225 
 
  if(!level[author.id]) level[author.id] = {level: 1, xp: 1};  //N' 1 C H O‘☥ •#3225 
 
 
  level[author.id].xp += (+random);  //N' 1 C H O‘☥ •#3225 
  if(level[author.id].xp >= 300) {  //N' 1 C H O‘☥ •#3225 
    if(level[author.id].xp > 300) xpLeft = level[author.id].xp - 300;  //N' 1 C H O‘☥ •#3225 
    level[author.id] = {  //N' 1 C H O‘☥ •#3225 
      level: level[author.id].level + 1,  //N' 1 C H O‘☥ •#3225 
      xp: xpLeft  //N' 1 C H O‘☥ •#3225 
    };
 
  }
  if(message.content.startsWith(prefix + "clan")) {  //N' 1 C H O‘☥ •#3225 
    if(message.content.split(' ')[0] !== `${prefix}clan`) return;  //N' 1 C H O‘☥ •#3225 
 
    if(!args[1] || args[1] && args[1] === 'info') {  //N' 1 C H O‘☥ •#3225 
  let embed = new Discord.RichEmbed()
  .setAuthor('الكلانات', message.author.avatarURL)  //N' 1 C H O‘☥ •#3225 
  ...
  .setFooter(message.author.username, message.author.avatarURL);  //N' 1 C H O‘☥ •#3225 
  message.channel.send(embed);
}
 
    if(args[1] && args[1] === 'create') {  //N' 1 C H O‘☥ •#3225 
      ...
      let awaited = await message.channel.awaitMessages(r => r.author.id === message.author.id, { max: 1, time: 20000, errors: ['time']}).then(collected => {
        ...
        nameClan = collected.first().content;  //N' 1 C H O‘☥ •#3225 
      });
 
      m = await m.edit('**# جارى عمل الكلان**');  //N' 1 C H O‘☥ •#3225 
      awaited = await setTimeout(async() => {  //N' 1 C H O‘☥ •#3225 
        let membersArray = {
          nameClan: {
            array: []
          }
        };
        let members = membersArray.nameClan.array;  //N' 1 C H O‘☥ •#3225 
        members.push(message.author.id);
        clans[nameClan] = {
          name: nameClan,
          createdAt: new Date().toLocaleString(),  //N' 1 C H O‘☥ •#3225 
          level: levelClan,
          creator: message.author.id,  //N' 1 C H O‘☥ •#3225 
          members: members,  //N' 1 C H O‘☥ •#3225 
          applylist: [],  //N' 1 C H O‘☥ •#3225 
          admins: []  //N' 1 C H O‘☥ •#3225   //N' 1 C H O‘☥ •#3225 
        };
 
        system[author.id] = {  //N' 1 C H O‘☥ •#3225 
          clan: nameClan,  //N' 1 C H O‘☥ •#3225 
          joinedAt: new Date().toLocaleString(),  //N' 1 C H O‘☥ •#3225 
          clanLevel: 0,  //N' 1 C H O‘☥ •#3225 
          creator: message.author.id  //N' 1 C H O‘☥ •#3225 
        };
 
        m = await m.edit('**# تم عمل الكلان بنجاح**');  //N' 1 C H O‘☥ •#3225 
      }, 2300);
 
    }
    if(args[1] && args[1] === 'invite') {  //N' 1 C H O‘☥ •#3225 
      if(!system[author.id]) return message.channel.send("**# أنت لست بكلان**");  //N' 1 C H O‘☥ •#3225 
      let clan = system[author.id].clan;
      if(system[author.id].clan === 'None') return message.channel.send('**# أنت لست بكلان**');  //N' 1 C H O‘☥ •#3225 
      ...
      let mention = message.mentions.users.first();  //N' 1 C H O‘☥ •#3225 
      if(!mention) return message.channel.send('**# منشن شخص لدعوته للكلان**');  //N' 1 C H O‘☥ •#3225 
      if(clans[clan].members.includes(mention.id)) return message.channel.send("**# هذا العضو بالكلان بالفعل**");  //N' 1 C H O‘☥ •#3225 
      if(clans[clan].members.length === 10) return message.channel.send("**# هذا الكلان وصل للحد الاقصى من الاعضاء يمكنك**");  //N' 1 C H O‘☥ •#3225 
   //N' 1 C H O‘☥ •#3225   //N' 1 C H O‘☥ •#3225   //N' 1 C H O‘☥ •#3225   //N' 1 C H O‘☥ •#3225   //N' 1 C H O‘☥ •#3225 
      ...
      let awaiting = await message.channel.awaitMessages(r => r.author.id === mention.id, {max: 1, time: 20000, errors:['time']}).then(collected => {
        collected.first().delete().catch();  //N' 1 C H O‘☥ •#3225 
        if(collected.first().content === 'نعم') {  //N' 1 C H O‘☥ •#3225 
          clans[clan].members.push(mention.id);  //N' 1 C H O‘☥ •#3225 
 
          system[author.id].members += 1;  //N' 1 C H O‘☥ •#3225 
 
 
          system[mention.id] = {  //N' 1 C H O‘☥ •#3225 
            clan: clan,
            joinedAt: new Date().toLocaleString(),  //N' 1 C H O‘☥ •#3225 
            clanLevel: 0,
            creator: clans[clan].creator  //N' 1 C H O‘☥ •#3225 
          };
 
          message.channel.send(`**${message.author} # تم قبول الدعوة**`);  //N' 1 C H O‘☥ •#3225 
        }  //N' 1 C H O‘☥ •#3225 
        if(collected.first().content === 'لا') {  //N' 1 C H O‘☥ •#3225 
          message.channel.send(`**${message.author} # تم رفض الدعوة**`);  //N' 1 C H O‘☥ •#3225 
        } else if(collected.first().content !== 'نعم' && collected.first().content !== 'لا'){  //N' 1 C H O‘☥ •#3225 
          return message.channel.send('**# يجب عليك كتابة `نعم` أو `لا`**');  //N' 1 C H O‘☥ •#3225 
        }  //N' 1 C H O‘☥ •#3225 
      });  //N' 1 C H O‘☥ •#3225 
    }  //N' 1 C H O‘☥ •#3225 
    if(args[1] && args[1] === 'stats') {
      if(system[author.id].clan === 'None') return message.channel.send('**# يجب ان تكون بكلان لأستخدام هذا الأمر**');  //N' 1 C H O‘☥ •#3225 
      let clan = system[author.id].clan;  //N' 1 C H O‘☥ •#3225 
      let embed = new Discord.RichEmbed()  //N' 1 C H O‘☥ •#3225 
        .setAuthor(`${message.author.username} || الكلانات`, message.author.avatarURL)  //N' 1 C H O‘☥ •#3225 
        .setDescription(`الكلان || \`${clan.toString()}\``)  //N' 1 C H O‘☥ •#3225 
        embed.addField('» اسم الكلان', clan, true)  //N' 1 C H O‘☥ •#3225 
        embed.addField('» تاريخ عمل الكلان', clans[clan].createdAt, true);  //N' 1 C H O‘☥ •#3225 
        embed.addField('» تاريخ دخول الكلان', system[author.id].joinedAt, true)  //N' 1 C H O‘☥ •#3225 
        embed.addField('» صاحب الكلان', `<@${clans[clan].creator}>`, true);  //N' 1 C H O‘☥ •#3225 
        embed.addField('» لفل الكلان', clans[clan].level, true);  //N' 1 C H O‘☥ •#3225 
        embed.addField('» عدد اعضاء الكلان', clans[clan].members.length, true);  //N' 1 C H O‘☥ •#3225 
        embed.addField('» عدد التقديمات للكلان', clans[clan].applylist.length, true);  //N' 1 C H O‘☥ •#3225 
        embed.addField('» عدد الادمنية بالكلان', clans[clan].admins.length, true);  //N' 1 C H O‘☥ •#3225 
        embed.addField('» اعضاء الكلان', `${prefix}clan list || يظهرلك رسالة بها اعضاء الكلان`);  //N' 1 C H O‘☥ •#3225 
      message.channel.send(embed);  //N' 1 C H O‘☥ •#3225 
 
    }
    if(args[1] && args[1] === 'join') {  //N' 1 C H O‘☥ •#3225   //N' 1 C H O‘☥ •#3225 
    let clanName = message.content.split(' ').slice(2).join(" ");  //N' 1 C H O‘☥ •#3225 
    if(system[author.id].clan !== 'None') return message.channel.send("**# يجب أن لا تكون بكلان**");  //N' 1 C H O‘☥ •#3225 
    if(!args[2]) return message.channel.send("**# يجب عليك كتابة اسم الكلان**");  //N' 1 C H O‘☥ •#3225 
    if(!clans[clanName]) return message.channel.send("**# هذا الكلان غير موجود**");  //N' 1 C H O‘☥ •#3225 
    if(clans[clanName].applylist.includes(message.author.id)) return message.channel.send("**# لقد قدمت على دخول هذا الكلان مسبقا");  //N' 1 C H O‘☥ •#3225 
   //N' 1 C H O‘☥ •#3225   //N' 1 C H O‘☥ •#3225   //N' 1 C H O‘☥ •#3225 
    clans[clanName].applylist.push(message.author.id);  //N' 1 C H O‘☥ •#3225 
    message.channel.send("**# لقد تم التقديم على دخول الكلان , سيتم الرد عليك من قبل احد ادارة الكلان**");  //N' 1 C H O‘☥ •#3225 
 
  }
    if(args[1] && args[1] === 'accept') {  //N' 1 C H O‘☥ •#3225 
      let mention = message.mentions.users.first();
      if(system[author.id].clan === 'None') return message.channel.send("**# يجب عليك ان تكون بكلان لأستخدام هذا الأمر**");  //N' 1 C H O‘☥ •#3225 
      ...
      if(!system[mention.id]) system[mention.id] = {clan: 'None',joinedAt: new Date().toLocaleString() ,clanLevel: 0};  //N' 1 C H O‘☥ •#3225 
      ...
      clans[system[author.id].clan].applylist.shift(mention.id);  //N' 1 C H O‘☥ •#3225 
      clans[system[author.id].clan].members.push(mention.id);  //N' 1 C H O‘☥ •#3225 
      let clan = system[author.id].clan;  //N' 1 C H O‘☥ •#3225 
   ...
   //N' 1 C H O‘☥ •#3225 
      ...
      mention.send(`**# \`${system[author.id].clan}\`, لقد تم قبولك بالكلان**`).catch();  //N' 1 C H O‘☥ •#3225 
      message.channel.send(`**# \`${mention.username}\`, لقد تم قبول الشخص ودخوله للكلان**`);  //N' 1 C H O‘☥ •#3225 
    }  //N' 1 C H O‘☥ •#3225 
    if(args[1] && args[1] === 'decline') {  //N' 1 C H O‘☥ •#3225 
      let mention = message.mentions.users.first();  //N' 1 C H O‘☥ •#3225 
      ...
      system[mention.id] = {  //N' 1 C H O‘☥ •#3225 
        clan: clans[system[author.id].clan],  //N' 1 C H O‘☥ •#3225 
        joinedAt: new Date().toLocaleString(),
        clanLevel: 0  //N' 1 C H O‘☥ •#3225 
      };
 
 
      mention.send(`**# \`${system[author.id].clan}\`, لقد تم رفض دخولك للكلان**`).catch();  //N' 1 C H O‘☥ •#3225 
      message.channel.send(`**# \`${mention.username}\`, لقد تم رفض دخول الشخص للكلان**`);  //N' 1 C H O‘☥ •#3225 
   //N' 1 C H O‘☥ •#3225 
    }
    if(args[1] && args[1] === 'promote') {
      ...
      if(system[mention.id].clan === 'None') return message.channel.send("**# هذا الشخص ليس بكلان**");  //N' 1 C H O‘☥ •#3225 
      if(!clans[system[author.id].clan].members.includes(mention.id)) return message.channel.send("**# هذا الشخص ليس بالكلان**");  //N' 1 C H O‘☥ •#3225 
      if(clans[system[author.id].clan].admins.includes(mention.id)) return message.channel.send("**# هذا العضو لديه ادمن بالفعل**");  //N' 1 C H O‘☥ •#3225 
      if(mention.id === message.author.id) return message.channel.send("**# لا يمكنك اعطاء نفسك ترقية**");  //N' 1 C H O‘☥ •#3225 
 
      clans[system[author.id].clan].admins.push(mention.id);  //N' 1 C H O‘☥ •#3225 
 
 
      mention.send(`**# \`${system[author.id].clan}\`, لقد تم ترقيتك الى ادمن**`).catch();  //N' 1 C H O‘☥ •#3225 
      message.channel.send(`**# \`${mention.username}\`, لقد تم ترقية العضو الى رتبة ادمن**`);  //N' 1 C H O‘☥ •#3225 
    }  //N' 1 C H O‘☥ •#3225 
    if(args[1] && args[1] === 'demote') {  //N' 1 C H O‘☥ •#3225 
      let mention = message.mentions.users.first();  //N' 1 C H O‘☥ •#3225 
      if(system[author.id].clan === 'None') return message.channel.send("**# يجب ان تكون بكلان لأستخدام هذا الأمر**");  //N' 1 C H O‘☥ •#3225 
      if(clans[system[author.id].clan].creator !== message.author.id) return message.channel.send("**# هذا الأمر لضاحب الكلان فقط**");  //N' 1 C H O‘☥ •#3225 
      if(!mention) return message.channel.send("**# يجب عليك منشنة عضو بالكلان لأعطائه الترقية**");  //N' 1 C H O‘☥ •#3225 
      if(!system[mention.id]) system[mention.id] = {clan: 'None',joinedAt: new Date().toLocaleString() ,clanLevel: 0};  //N' 1 C H O‘☥ •#3225 
   //N' 1 C H O‘☥ •#3225 
      if(system[mention.id].clan === 'None') return message.channel.send("**# هذا الشخص ليس بكلان**");  //N' 1 C H O‘☥ •#3225 
      if(!clans[system[author.id].clan].members.includes(mention.id)) return message.channel.send("**# هذا الشخص ليس بالكلان**");  //N' 1 C H O‘☥ •#3225 
      if(!clans[system[author.id].clan].admins.includes(mention.id)) return message.channel.send("**# هذا الشخص ليس ادمن بالكلان**");  //N' 1 C H O‘☥ •#3225 
      if(mention.id === message.author.id) return message.channel.send("**# لا يمكنك اعطاء نفسك ترقية**");  //N' 1 C H O‘☥ •#3225 
   //N' 1 C H O‘☥ •#3225 
      clans[system[author.id].clan].admins.shift(mention.id);  //N' 1 C H O‘☥ •#3225 
...
client.on('roleUpdate', (oldRole, newRole) => {
 ...
 client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: WebSite:gear: **" , "  https://drawbot.netlify.com/")
...
const devs = ["433388051222233098","434757108790198272"]
...
.setTitle ("🇲🇦 🕌 الاذان على حسب توقيت غرينيتش 🕌🇲🇦")
...
client.on('guildMemberAdd', member => {
    ...
    let embed = new Discord.RichEmbed()
        ...
        .addField(':v::running_shirt_with_sash: | name :  ',`${member}`)
        .addField(':v: :loudspeaker:  | اطلق من دخل شخص جديد' , `اهلاً بك في السيرفر, ${member}`)
        .addField(':v: :id:  | user :', "**[" + `${member.id}` + "]**" )
...
client.on('guildMemberAdd', member=> {
  ...
  if (message.author.id !== "434757108790198272") return;
...
client.on('message', message => {
  ...
  var args = message.content.split(' ').slice(1);
  var argresult = args.join(' ');
  if (message.author.id !== "433388051222233098") return;
...
"⇁ Youtubers‏‏༄  ❥", "⇁『Members』‏‏༄  ❥");//N1CHO
if(message.content.startsWith(prefix + "aroles")) {//N1CHO
  if(!message.member.hasPermission('ADMINISTRATOR')) return      message.channel.send('**للأسف لا تمتلك صلاحية** `ADMINISTRATOR`' );
  if(message.author.bot) return;//N1CHO
  if(roles) return message.reply('**الرتب موجوده بالفعل**')//N1CHO
  //دى بقا الرتب ال انت عاوزو يعملها
  let roleking = message.guild.roles.find(r => r.name === "» Founders  ❥");//N1CHO
  if(!roleking) {
...
let rolebigboss = message.guild.roles.find(r => r.name === "» Developpers  ❥");//N1CHO
if(!rolebigboss) {//N1CHO
...
let rolecaptain = message.guild.roles.find(r => r.name === "» Moderators  ❥");//N1CHO
if(!rolecaptain) {//N1CHO
message.guild.createRole({
    name: '» Moderators  ❥',
    color: 'RANDOM',
    postion: (4),
...
let rolesergant = message.guild.roles.find(r => r.name === "» VIP  ❥");//N1CHO
if(!rolesergant) {
 message.guild.createRole({
    name: '» VIP  ❥',
    color: 'RANDOM',//N1CHO
...
let roleyoutuber = message.guild.roles.find(r => r.name === "⇁ Youtubers‏‏༄  ❥");
if(!roleyoutuber) {//N1CHO
  message.guild.createRole({
    name: '⇁ Youtubers‏‏༄  ❥',
    color: 'RANDOM',
    postion: (6),
...
let roleactive = message.guild.roles.find(r => r.name === "⇁『Members』‏‏༄  ❥");//N1CHO
if(!roleactive) {//N1CHO
 message.guild.createRole({
  name: '⇁『Members』‏‏༄  ❥',
  color: 'RANDOM',
  postion: (7),
  hoist: (true),//N1CHO
  permissions: ['VIEW_CHANNEL', 'READ_MESSAGES', 'SEND_MESSAGES', 'EMBED_LINKS', 'ATTACH_FILES', 'CONNECT', 'SPEAK',//N1CHO
  'READ_MESSAGE_HISTORY', 'MOVE_MEMBERS', 'USE_VAD', 'CHANGE_NICKNAME', 'ADD_REACTIONS']//N1CHO
})
message.guild.createRole({//N1CHO
  name: 'Fortnite',
  color: 'RANDOM',//N1CHO
...
message.guild.createRole({
  name: 'creative-destruction',//N1CHO
  color: 'RANDOM',
  postion: (7),
  permissions: ['VIEW_CHANNEL', 'READ_MESSAGES', 'SEND_MESSAGES', 'EMBED_LINKS', 'ATTACH_FILES', 'CONNECT', 'SPEAK',
  'READ_MESSAGE_HISTORY', 'MOVE_MEMBERS', 'USE_VAD', 'CHANGE_NICKNAME', 'ADD_REACTIONS']
...
message.channel.send(message.member + '**جارى انشاء الرتب**').then((m)=> {
  setTimeout(() => {//N1CHO
    m.edit('**N1CHO تم انشاء الرتب من قبل عمك**')
  }, 3000);//N1CHO
})
}//N1CHO
}
...
client.on("message", message =>{
  ...
  let rolecsgo = message.guild.roles.find(r => r.name === "⇁『counter-strik』‏e』‏‏❥");
...
//N1CHO
  let roles = message.guild.roles.find(all=> all.name === "» Founders  ❥", "» Server Managers  ❥", "» Developpers  ❥", "» Moderators  ❥", "» VIP  ❥",
"⇁ Youtubers‏‏༄  ❥", "⇁『Members』‏‏༄  ❥");//N1CHO
  if(message.content.startsWith(prefix + "achannels")) {
if(!message.member.hasPermission('ADMINISTRATOR')) return      message.channel.send('**للأسف لا تمتلك صلاحية** `ADMINISTRATOR`' );
if(!roles) return message.reply("**من فضلك قم بكتابة هذا الامر حتى يتم انشاء الرتب اولا !aroles**")//N1CHO
if(roles) {//N1CHO
message.reply("**جارى انشاء الرومات**").then((c)=> {//N1CHO
setTimeout(() => {
  c.edit("**N1CHO تم انشاء الرومــــات من قيل عمك**")//N1CHO
}, 10000);
})
message.guild.createChannel(`.INFO| 📜 .` , 'category').then(tb => {//N1CHO
  message.guild.createChannel('⇁『Welcome』' , 'text').then(nws => {
    nws.setParent(tb);
    nws.overwritePermissions(message.guild.id, {
      SEND_MESSAGES: false,
      MENTION_EVERYONE: false//N1CHO
})
  })
  message.guild.createChannel('⇁『Info』' , 'text').then(inf => {//N1CHO
    inf.setParent(tb);//N1CHO
    inf.overwritePermissions(message.guild.id, {//N1CHO
      SEND_MESSAGES: false,
      MENTION_EVERYONE: false//N1CHO
})
  })
    message.guild.createChannel('⇁『News』' , 'text').then(nws => {//N1CHO
      nws.setParent(tb);
      nws.overwritePermissions(message.guild.id, {//N1CHO
        SEND_MESSAGES: false,
        MENTION_EVERYONE: false//N1CHO
})
    })//N1CHO
      message.guild.createChannel('⇁『Chat』' , 'text').then(cht => {//N1CHO
        cht.setParent(tb);
        cht.overwritePermissions(message.guild.id, {
          MENTION_EVERYONE: false//N1CHO
  })
      })
        message.guild.createChannel('⇁『Bot-CMD』' , 'text').then(cmd => {//N1CHO
          cmd.setParent(tb);
          cmd.overwritePermissions(message.guild.id, {//N1CHO
            MENTION_EVERYONE: false//N1CHO
    })
        })
          message.guild.createChannel('⇁『Announces』' , 'text').then(yt => {//N1CHO
            yt.setParent(tb);//N1CHO
            yt.overwritePermissions(roleOwners, {
              SEND_MESSAGES: true
          })
          yt.overwritePermissions(message.guild.id, {//N1CHO
            SEND_MESSAGES: false,
            MENTION_EVERYONE: false
          })
          })//N1CHO
          message.guild.createChannel('⇁『Reports』' , 'text').then(pic => {//N1CHO
            pic.setParent(tb);
            pic.overwritePermissions(message.guild.id, {
              MENTION_EVERYONE: false
      })
          })
            message.guild.createChannel('⇁『Giveaways』' , 'text').then(cut => {
              cut.setParent(tb);
  ...
  message.guild.createChannel(`» Games-Chat` , 'category').then(tb => {//N1CHO
  ...
  message.guild.createChannel('⇁『playerunknowns』' , 'text').then(ch => {//N1CHO
    ch.setParent(tb);
    ch.overwritePermissions(message.guild.id, {//N1CHO
      SEND_MESSAGES: false,
      MENTION_EVERYONE: false
})
ch.overwritePermissions(rolepubg, {//N1CHO
  SEND_MESSAGES: true,
  MENTION_EVERYONE: false//N1CHO
})
  })
    message.guild.createChannel('⇁『counter-strike』' , 'text').then(ch => {//N1CHO
      ch.setParent(tb);
      ch.overwritePermissions(message.guild.id, {
        SEND_MESSAGES: false,//N1CHO
        MENTION_EVERYONE: false
})
ch.overwritePermissions(rolecsgo, {
  ...
  MENTION_EVERYONE: false
      ...
      message.guild.createChannel('⇁『creative-destruction』' , 'text').then(ch => {//N1CHO
        ch.setParent(tb);
        ch.overwritePermissions(rolecd, {
          SEND_MESSAGES: true,//N1CHO
          MENTION_EVERYONE: false
      })
      ch.overwritePermissions(message.guild.id, {
        SEND_MESSAGES: false,
        ...
        message.guild.createChannel('⇁『gta』' , 'text').then(ch => {//N1CHO
          ch.setParent(tb);
        ...
        ch.overwritePermissions(message.guild.id, {
          ...
          message.guild.createChannel('⇁『minecraft』' , 'text').then(ch => {//N1CHO
            ch.setParent(tb);
  ...
  message.guild.createChannel(`.HELLO| 🔊 .` , 'category').then(tb => {//N1CHO
...
message.guild.createChannel(`.Talking | ✋🏽 .` , 'category').then(tb => {
  message.guild.createChannel(`صـــــالــون | 🔊 .」` , 'voice').then(ch => {//N1CHO
    ch.setParent(tb);
    ch.setUserLimit(50)//N1CHO
})
message.guild.createChannel('「Sounds | ♫ .」' , 'voice').then(ch => {//N1CHO
  ch.setParent(tb);
  ch.setUserLimit(50)//N1CHO
})
  })
  message.guild.createChannel(`» Games | الالعاب .` , 'category').then(tb => {//N1CHO
  ...
  ch.overwritePermissions(rolemc, {//N1CHO
    CONNECT: true,
...
message.guild.createChannel('🔊Legends | لـــــول' , 'voice').then(ch => {//N1CHO
  ch.setParent(tb);
  ch.overwritePermissions(message.guild.id, {
    CONNECT: false,
...
ch.overwritePermissions(rolelol, {
  ...
  message.guild.createChannel(`» DJ | الموسيقي .` , 'category').then(tb => {//N1CHO
    message.guild.createChannel(`» Art.` , 'voice').then(ch => {
      ch.setParent(tb);
      ch.setUserLimit(15)//N1CHO
  })
...
ch.setUserLimit(15)
  ...
  message.guild.createChannel(`» Privates | خآص .` , 'category').then(tb => {//N1CHO
...
『!aroles ====> يقوم بانشاء الرتب
『!achannels ====> يقوم بانشاء الرومات
...
『!support ====> سرفر البوت للدعم
『!web ====> صفحة البوت
『!v2min ====> لصنع روم صوتي مؤقت
『!invite ====> لدعوة البوت الى سيرفرك
『!اذان  ====> توقيت الاذان على حسب توقيت غرينيتش
**
`)
...
`)
   message.author.sendEmbed(embed)
   message.reply('تــم ارسال لك في الخاص')
})
reaction3.on("collect", r => {
  const embed = new Discord.RichEmbed()
      .setColor("#000000")
